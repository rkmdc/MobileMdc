...
var SwipeView = (function(f, m) {
    var k = m.createElement("div").style, r = (function() {
        var x = "t,webkitT,MozT,msT,OT".split(","), w, v = 0, u = x.length;
        for (; v < u; v++) {
            w = x[v] + "ransform";
            if (w in k) {
        ...
        return false;
    })(), s = r ? "-" + r.toLowerCase() + "-" : "", j = n("transform"), i = n("transitionDuration"), h = n("perspective") in k, q = "ontouchstart" in f, c = !!r, d = n("transition") in k, t = h ? " translateZ(0)" : "", g = "onorientationchange" in f ? "orientationchange" : "resize", o = q ? "touchstart" : "mousedown", b = q ? "touchmove" : "mousemove", l = q ? "touchend" : "mouseup", p = q ? "touchcancel" : "mouseup", a = (function() {
        if (r === false) {
            return false;
        }
        var u = {"": "transitionend", webkit: "webkitTransitionEnd", Moz: "transitionend", O: "oTransitionEnd", ms: "MSTransitionEnd"};
        return u[r];
    })(), e = function(y, v) {
        var w, z, x, u;
    ...
    e.prototype = {currentMasterPage: 1, x: 0, page: 0, pageIndex: 0, customEvents: [], onFlip: function(u) {
            ...
            var u = m.getElementById("app-content");
            u.style.height = f.innerHeight + "px";
            ...
            var v = q ? x.touches[0] : x, w = v.pageX - this.pointX, u = v.pageY - this.pointY, z = this.x + w, y = Math.abs(v.pageX - this.startX);
            this.moved = true;
            this.pointX = v.pageX;
            this.pointY = v.pageY;
            ...
            var u = q ? v.changedTouches[0] : v, w = Math.abs(u.pageX - this.startX);
            this.initiated = false;
            if (!this.moved) {
                return;
            }
